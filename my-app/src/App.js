    ...
    <div className="App">
      ...
      <div className="leftSide">
        ...
        <div className="leftmid">
          <button><i className='bx bx-plus'></i>New Chat</button>
        </div>
        ...
        <div className="leftFooter">
          <div className="premium footerflex">
            <i className='bx bx-purchase-tag-alt green'></i><span> Premium Subscription</span>
          </div>
          <div className="user footerflex">
            <i className='bx bx-child green'></i><span> User Account</span>
          </div>
        </div>
      </div>
      ...
      <div className="rightSide">
        ...
        <div className="chatFooter">
          <div className="input">
            <input type="text" value={input} placeholder="Ask me Something ..." onChange={(e) => setInput(e.target.value)} /> <button className="send" onClick={handleInput}><i className='bx bx-send' ></i></button>
          </div>
        </div>
